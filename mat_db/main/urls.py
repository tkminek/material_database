...
urlpatterns = [
    ...
    path('material_type_list/steel_al/<int:material_type_id>/<int:material_id>/create_custom_curve/', views.create_custom_curve, name="create_custom_curve"),
    ...
    path('material_type_list/plastic/<int:material_type_id>/<int:plastic_id>/<int:water_id>/<int:temp_id>/<int:fibre_id>/create_custom_curve/', views.create_custom_plastic_curve, name="create_custom_plastic_curve"),
