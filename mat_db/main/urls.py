...
urlpatterns = [
    ...
    path('material_type_list/<int:material_type_id>/steel_al/<int:material_id>', views.material_info, name="material_info"),
    path('material_type_list/<int:material_type_id>/hose/<int:hose_id>', views.hose_info, name="hose_info"),
    path('material_type_list/<int:material_type_id>/plastic/<int:plastic_id>', views.water_info, name="water_info"),
    path('material_type_list/<int:material_type_id>/rubber/<int:rubber_id>', views.rub_info, name="rub_info"),
